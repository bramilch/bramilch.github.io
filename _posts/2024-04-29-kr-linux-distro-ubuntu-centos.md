...
- [CentOS 프로젝트와 Red Hat의 결정](#centos-프로젝트와-red-hat의-결정)
  - [The CentOS Project 누가, 왜 시작했고, CentOS 7, 8 종료 결정이 되었을까](#the-centos-project-누가-왜-시작했고-centos-7-8-종료-결정이-되었을까)
- [참고자료](#참고자료)
...
- 그 중 레드햇 계열과 데비안 계열의 차이를 알아보고, 레드햇 계열의 CentOS와 데비안 계열의 Ubuntu를 비교하겠음.
...
### The CentOS Project 누가, 왜 시작했고, CentOS 7, 8 종료 결정이 되었을까
